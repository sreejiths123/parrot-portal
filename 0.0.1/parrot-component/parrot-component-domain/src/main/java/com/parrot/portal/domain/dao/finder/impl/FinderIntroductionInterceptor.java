package com.parrot.portal.domain.dao.finder.impl;
...
/**
 * Connects the Spring AOP magic with the Hibernate DAO magic For any method beginning with "find"
 * this interceptor will use the FinderExecutor to call a Hibernate named query
 */
